...
public class GrillePlacesTest {
	...
	public void testGrilleEasy() {
		// 3 mots
		Grille gr = GrilleLoader.loadGrille("src/data/easy.grl");
	...
	public void testGrilleEnonce() {
		Grille gr = GrilleLoader.loadGrille("src/data/enonce.grl");
	...
	public void testGrilleEasy2() {
		...
		Grille gr = GrilleLoader.loadGrille("src/data/easy2.grl");
	...
	public void testGrilleSplit() {
		...
		Grille gr = GrilleLoader.loadGrille("src/data/split.grl");
	...
	public void testGrilleMedium() {
		Grille gr = GrilleLoader.loadGrille("src/data/medium.grl");
	...
	public void testGrilleHard() {
		Grille gr = GrilleLoader.loadGrille("src/data/hard.grl");
	...
	public void testGrilleLarge() {
		Grille gr = GrilleLoader.loadGrille("src/data/large.grl");
	...
	public void testGrilleLarge2() {
		Grille gr = GrilleLoader.loadGrille("src/data/large2.grl");
