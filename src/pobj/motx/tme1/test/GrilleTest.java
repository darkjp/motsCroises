...
public class GrilleTest {
	...
	public void testGrille() {
		...
		gr = GrilleLoader.loadGrille("src/data/enonce.grl");

		assertEquals(16, gr.nbCol());
		assertEquals(12, gr.nbLig());

		gr = GrilleLoader.loadGrille("src/data/large2.grl");
	...
	public void testIO() {
		...
		String f1 = "src/data/large2.grl";
		String f2 = "src/data/reverse.grl";
